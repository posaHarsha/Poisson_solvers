...
float* RHS(int n_e,int n_n,int count,int**Element_node,float*Ve1,int z,int* Boundary_nodes,float** NodeCoordinate,int Vl, int Vr,float V[]){
    ...
    for(int i=0; i<n_e; i++){
        ...
        S[Element_node[i][1] - 1] = S[Element_node[i][1] - 1] + V[Element_node[i][0] - 1]*V[Element_node[i][0] - 1]; 
        S[Element_node[i][2] - 1] = S[Element_node[i][2] - 1] + V[Element_node[i][0] - 1]*V[Element_node[i][0] - 1]; 
        S[Element_node[i][3] - 1] = S[Element_node[i][3] - 1] + V[Element_node[i][0] - 1]*V[Element_node[i][0] - 1];
    }
